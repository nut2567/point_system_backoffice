...
export default function RootLayout({ children }) {
  ...
  return (
    <ProtectedPage>
      ...
      <div
        className={`transition-all duration-300 ${sidebarOpen && !mobile ? "ml-64" : ""}`}
      >
        <div className=" min-h-dvh bg-zinc-200 m-5 text-neutral-950 rounded-box items-center flex-col flex py-10">
          {children}
        </div>
      </div>
